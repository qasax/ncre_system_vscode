<template>
  ...
  <div style="margin-top: 20px;margin-bottom: 20px;margin-left: 20px;">
    ...
    <el-button @click="window.location.href='http://localhost:8080/file/examRoomDown'">表格导出</el-button>
    <el-upload ref="upload"
               class="upload-demo"
               action="http://localhost:8080/file/examRoomUpload"
               :limit="1"
  ...
  <el-table ref="multipleTableRef"
            ...
            :default-sort="{prop: 'examRoomID', order: 'ascending'}">
