    ...
    <div style="width: 30%;margin: auto;">
      <el-form style="margin-top: 50px;" ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="120px"
        ...
        <el-form-item label="序号">
            <el-input v-model="ruleForm.ereID"  :readonly="true"></el-input>
        </el-form-item>
        <el-form-item label="考试科目">
              <el-input v-model="ruleForm.examName"  :readonly="true"></el-input>
          </el-form-item>
        ...
        formEl.validate((valid) => {
          if (valid) {
            ...
            ElMessageBox.confirm(
              ...
              .then(() => {
                console.log(ruleForm)
                axios.post('http://localhost:8080/examRoomExam/update', ruleForm)
                  .then((response) => {
                    console.log(response.data)
                    ElMessage({
                      type: 'success',
