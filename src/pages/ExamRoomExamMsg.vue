<template>
  ...
  <div style="margin-top: 20px;margin-bottom: 20px;margin-left: 20px;">
    ...
    <el-button @click="window.location.href='http://localhost:8080/file/examRoomExamDown'">表格导出</el-button>
    <el-upload ref="upload"
               class="upload-demo"
               action="http://localhost:8080/file/examRoomExamUpload"
               :limit="1"
...
export default {
  setup () {
    ...
    return {
      ...
      addExamRoomMsg,
      toReset,
      handleExceed, submitUpload, upload, window
    }
  },
  components: {
    ElTable,
