    ...
    <div style="width: 30%;margin: auto;">
      <el-form style="margin-top: 50px;" ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="120px"
        ...
        <el-form-item label="考试科目" prop="examID">
          <el-select  v-model="ruleForm.examID" placeholder="请选择">
            <el-option v-for="(exam, index) in exams" :key="index" :label="exam.examName" :value="exam.examID" >
            </el-option>
          </el-select>
        </el-form-item>
...
params:{
      ...
      let ruleForm = reactive({
        ...
        watch(ruleForm,(newValue,oldValue)=>{
            ...
            axios.get("http://localhost:8080/examroom/selectIt",{params:{
          ...
          if (valid) {
            ...
            ElMessageBox.confirm(
              ...
              .then(() => {
                ...
                axios.post('http://localhost:8080/examRoomExam/addOne', ruleForm)
                  .then((response) => {
                    console.log(response.data)
                    ElMessage({
                      type: 'success',
